...
/** @type {string} */
const CACHE_VERSION = '1764065027|356575033';
/** @type {string} */
const CACHE_PREFIX = 'Collector-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'MeticulousCollector.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["MeticulousCollector.html","MeticulousCollector.js","MeticulousCollector.offline.html","MeticulousCollector.icon.png","MeticulousCollector.apple-touch-icon.png","MeticulousCollector.audio.worklet.js","MeticulousCollector.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["MeticulousCollector.wasm","MeticulousCollector.pck","MeticulousCollector.side.wasm"];
